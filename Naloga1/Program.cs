...
class Program
{
    static void Main(string[] args)
    {
        ...
        Ata Uroš = new Ata("Uroš", "Nekaj", DateTime.Parse("29.3.1965"), "Računalničar", "Feri", 38);
        Mama Bernarda = new Mama("Bernarda", "Nekaj", DateTime.Parse("18.10.1973"), "Informatika", "Fri", 30);
        Otrok Jaz = new Otrok("Arnož", "Nekaj", DateTime.Parse("2.7.2003"), "Feri", "Športna", 21);
        Otrok Brat = new Otrok("Rožle", "Nekaj", DateTime.Parse("18.1.1990"), "EPF", "Matematika", 34);
        Otrok Manja = new Otrok("Manja", "Nekaj", DateTime.Parse("19.9.1991"), "Turistični faks", "Anglescina", 33);

        List<Otrok> otroci1 = new List<Otrok> { Jaz, Manja, Brat };
        Console.WriteLine("TU NAPREJ PROBAM DODAT OTROKA PA UPAM DA DELA:");
